...
template <typename T,int MAX>
void destroi(ListaEstaticaGenerica<T, MAX> &lista){                             //Destroi a lista
    lista.cardinalidade = 0;                                                    //Reseta a cardinalidade
}                                                                               //(os elementos não são deletados e sim sobreescritos depois)
